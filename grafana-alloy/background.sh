...
declare -A VSIX_FILES=(
  ...
  []["jeff-hykin.better-shellscript-syntax-1.10.0.vsix"]="https://open-vsx.org/api/jeff-hykin/better-shellscript-syntax/1.10.0/file/jeff-hykin.better-shellscript-syntax-1.10.0.vsix"
)
